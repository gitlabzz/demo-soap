node {
    ...
    def environments = [dev : [BACKEND_PROTOCOL: "http", BACKEND_HOST: "172.16.63.1", BACKEND_PORT: "8081"],
                        sit : [BACKEND_PROTOCOL: "http", BACKEND_HOST: "172.16.63.1", BACKEND_PORT: "8081"],
                        uat : [BACKEND_PROTOCOL: "http", BACKEND_HOST: "172.16.63.1", BACKEND_PORT: "8081"],
                        prod: [BACKEND_PROTOCOL: "http", BACKEND_HOST: "172.16.63.1", BACKEND_PORT: "8081"],]
    ...
    stage("Checkout Code (${pullRequest ? 'PR-' + pullRequest : branchName})") {
        if (pullRequest) {
            ...
            try {
                git branch: '${BRANCH_NAME}', credentialsId: '2bc605b8-3d32-4c7b-84e2-4d858bc31c46', url: 'https://github.com/gitlabzz/demo-soap.git'
            } catch (exception) {
                sh '''
